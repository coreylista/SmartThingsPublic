...
metadata {
	definition(name: "Iris Contact Sensor", namespace: "smartthings", author: "SmartThings") {
		...
		fingerprint inClusters: "0000,0001,0003,0402,0500,0020,0B05,FC02", outClusters: "0019", manufacturer: "CentraLite", model: "3320", deviceJoinName: "Iris Contact Sensor"
	...
	tiles(scale: 2) {
		...
		details(["status", "temperature", "battery", "refresh"])
	}
}
