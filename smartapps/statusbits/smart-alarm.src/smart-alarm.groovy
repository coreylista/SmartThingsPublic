 ...
 *  information.
 *
 *  Version 2.4.4 (05/31/2017)
 *
 *  The latest version of this file can be found on GitHub at:
 *  <https://github.com/statusbits/smartalarm/blob/master/SmartAlarm.groovy>
 *
 *  Corey Lista - 05/31/2017
 *  Edited version from the at this location that has Door Chime support 
 *  https://github.com/miriad/Centralite-Keypad/tree/master/smartapps
 *  I also added a 10 second entry delay option.
 *
 *  --------------------------------------------------------------------------
 *
...
def pageArmingOptions() {
    ...
    def inputDelay = [
        name:       "delay",
        type:       "enum",
        metadata:   [values:["10","30","45","60","90"]],
